...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/FlowersnIce-cream/Google Drev/EmotionalMetaMemory/code/tasks/survey_pavlovia/SurveyExpMetaMem.py',
...
introText = visual.TextStim(win=win, name='introText',
    text='Welcome To The Word-Rating Survey \nI appreciate you for participating in this part of the study. The survey being conducted today is investigating emotion, and \nconcerns how people respond to different types of words. On the next screens you will see some figures.\nWe call these figures SAM, and you will be using these figures to rate how different words seem to you. \nSAM shows two different kinds of feelings: \nHappy vs. Unhappy \nand \nExcited vs. Calm. \nYou will use both of these ratings for each word that is presented to you. Please notice that both feelings are arrayed along a 9-point scale. \n\nOn the happy vs. unhappy scale, which ranges from a frown to a smile, 9 means happy, pleased, satisfied, contented or hopeful. \n1 on the other hand means unhappy, annoyed, unsatisfied, melancholic, despaired, or bored. If the word feels completely neutral to you, neither happy nor sad, \nyou can select 5 on the ratingscale. \n\nOn the excited vs. calm scale, which ranges from a SAM to an exploding SAM, 9 means stimulated, excited, frenzied, jittered, or aroused. \n1 on the other hand means relaxed, calm, sluggish, dull, sleepy, or unaroused. If the word feels completely neutral to you, neither exciting nor calm, \nyou can select 5 on the ratingscale. \n\nThere will be a total of 1200 words that you will need to rated and you will be compensated 100kr for helping us with this survey part ofthe study.\n\nPlease work at a rapid place and don’t spend too much time thinking about each word. Rather, make your ratings based on your first\nand immediate reaction as you read each word. \n\nClick the screen to continue.',
    font='Arial',
...
InstructValenceText = visual.TextStim(win=win, name='InstructValenceText',
    text='This Is The Scale For Valence Ratings\nA 1 On The Sclae Equals To Very Low Valence\nA 9 On The Sclae Equals To Very High Valence\n\nClick On The Screen To Continue',
    font='Arial',
...
Valence = visual.ImageStim(
    ...
    ori=0, pos=(0, 0.25), size=(0.50, 0.25),
...
InstructArousalText = visual.TextStim(win=win, name='InstructArousalText',
    text='This Is The Scale For Arousal Ratings\nA 1 On The Sclae Equals To Very Low Arousal\nA 9 On The Sclae Equals To Very High Arousal\n\nClick On The Screen To Continue',
    font='Arial',
    pos=(0, 0), height=0.025, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
WordPresentation = visual.TextStim(win=win, name='WordPresentation',
    ...
    languageStyle='LTR',
    depth=0.0);
rating_3 = visual.RatingScale(win=win, name='rating_3', marker='triangle', size=1.0, pos=[0.0, -0.4], low=1, high=9, labels=[''], scale='', singleClick=True)
ArousalGuide = visual.ImageStim(
    win=win,
    name='ArousalGuide', 
    image='Arousal.png', mask=None,
    ori=0, pos=(0, .25), size=(0.50, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-2.0)
text_3 = visual.TextStim(win=win, name='text_3',
    text='1 = Excited, 9 = Calm',
    font='Arial',
    pos=(0, 0), height=0.04, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
ValenceImage = visual.ImageStim(
    ...
    name='ValenceImage', 
    image='Valence.png', mask=None,
    ori=0, pos=(0, .25), size=(0.5, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
ValenceRating = visual.RatingScale(win=win, name='ValenceRating', marker='triangle', size=1.0, pos=[0.0, -0.4], low=1, high=9, labels=[''], scale='', singleClick=True)
text_2 = visual.TextStim(win=win, name='text_2',
    text='1 = Unhappy, 9 = Happy\n',
    font='Arial',
    pos=(0, 0), height=0.04, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisTrial in trials:
    ...
    rating_3.reset()
    # keep track of which components have finished
    Arousal_2Components = [WordPresentation, rating_3, ArousalGuide, text_3]
    ...
    trials.addData('rating_3.response', rating_3.getRating())
    trials.addData('rating_3.rt', rating_3.getRT())
    trials.addData('rating_3.started', rating_3.tStart)
    trials.addData('rating_3.stopped', rating_3.tStop)
    ...
    ValenceRating.reset()
    # keep track of which components have finished
    Valence_2Components = [WordPresentation2, ValenceImage, ValenceRating, text_2]
    ...
    # store data for trials (TrialHandler)
    trials.addData('ValenceRating.response', ValenceRating.getRating())
    trials.addData('ValenceRating.rt', ValenceRating.getRT())
    trials.addData('ValenceRating.started', ValenceRating.tStart)
    trials.addData('ValenceRating.stopped', ValenceRating.tStop)
