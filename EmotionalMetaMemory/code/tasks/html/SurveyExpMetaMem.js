...
function Intro_To_ClickRoutineBegin() {
  ...
  for (const thisComponent of Intro_To_ClickComponents)
...
function valence_instructionRoutineBegin() {
  ...
  for (const thisComponent of valence_instructionComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function arousal_instructionRoutineBegin() {
  ...
  for (const thisComponent of arousal_instructionComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Arousal_2RoutineBegin() {
  ...
  for (const thisComponent of Arousal_2Components)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function Valence_2RoutineBegin() {
  ...
  for (const thisComponent of Valence_2Components)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
