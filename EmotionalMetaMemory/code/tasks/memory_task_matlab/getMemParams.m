...
sub_lists = [word_list.List]';
this_study_list = sub_lists == studyList;
this_unstudy_list = sub_lists == unstudyList;
total_word_list = upper([word_list.Word]');


params.studied_list = total_word_list(this_study_list);
params.unstudied_list = total_word_list(this_unstudy_list);
